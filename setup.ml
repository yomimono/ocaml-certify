...
(* OASIS_START *)
(* DO NOT EDIT (digest: 72bc0d5af1a9a9a06eba6a1a315c35d6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "generate self-signed certificates with ocaml-x509 & ocaml-nocrypto";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "src/selfsign.ml"});
               Executable
                 ({
                     cs_name = "csr";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "src/csr.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\174\016FK\254\219\253\154\190>\231\237D\134#v";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
