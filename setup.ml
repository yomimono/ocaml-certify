...
(* OASIS_START *)
(* DO NOT EDIT (digest: e1988fb33bd6cc5a7f934798bd88b714) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "certify.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\186;*\218v\029\174\t\r\186\249\228\1957\1541";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
